                  ...
                  children: [
                    ...
                    Row(children: [
                      _HeaderChip(
                          label: 'Ort. Sentiment',
                          value:
                              '${avgSentiment >= 0 ? '+' : ''}${avgSentiment.toStringAsFixed(2)}',
                          color: avgSentiment >= 0.15
                              ? AppColors.primary
                              : avgSentiment <= -0.15
                                  ? AppColors.danger
                                  : AppColors.warning,
                      ...
                      _HeaderChip(
                          label: 'Yükseliş',
                          value: '$bullishCount/${_assets.length}',
                          color: AppColors.primary,
                          icon: Icons.trending_up_rounded),
                      const SizedBox(width: 10),
                      _HeaderChip(
                          label: 'Düşüş',
                          value: '$bearishCount/${_assets.length}',
              ...
              delegate: SliverChildBuilderDelegate(
                (context, i) => CryptoCard(
                  ...
                  onTap: () => Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (_) =>
                              CryptoDetailScreen(asset: _assets[i]))),
                ),
